...
check("06_widget_boundary", "luhmDelivery" in front and "Silent install:</b> forbidden" in front and "Runtime.getRuntime().exec" not in front, "delivery widget is receipt UI, not installer")
...
route = manifest.get("delivery_route", [])
drive = manifest.get("google_drive", {})
